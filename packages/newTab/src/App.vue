...
<template>
  <main
    class="overscroll-contain overflow-y-auto w-screen h-screen grid xl:grid-cols-3 xl:gap-10 2xl:grid-cols-5 grid-rows-[7rem_1fr] 2xl:gap-4 p-4"
  >
    <TClock class="xl:col-start-2 2xl:col-start-4" />
